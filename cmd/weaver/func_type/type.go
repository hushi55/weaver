...
// Borrowed from github.com/go-delve/delve/pkg/dwarf/godwarf/type.go
...
func (t *BasicType) Underlying() types.Type { return t }
...
func (t *QualType) Underlying() types.Type { return t }
...
func (t *ArrayType) Underlying() types.Type { return t }
...
func (t *VoidType) Underlying() types.Type { return t }
...
func (t *PtrType) Underlying() types.Type { return t }
...
func (t *StructType) Underlying() types.Type { return t }
...
func (t *SliceType) Underlying() types.Type { return t }
...
func (t *InterfaceType) Underlying() types.Type { return t }
...
func (t *EnumType) Underlying() types.Type { return t }
...
func (t *FuncType) Underlying() types.Type { return t }
...
func (t *DotDotDotType) Underlying() types.Type { return t }
...
func (t *TypedefType) Underlying() types.Type { return t }
...
func (t *MapType) Underlying() types.Type { return t }
...
func (t *ChanType) Underlying() types.Type { return t }
...
func (t *UnsupportedType) Underlying() types.Type { return t }

// ReadType reads the type at off in the DWARF ``info'' section.
func ReadType(d *dwarf.Data, index int, off dwarf.Offset) (Type, error) {
	typeCache := make(map[dwarf.Offset]Type)
